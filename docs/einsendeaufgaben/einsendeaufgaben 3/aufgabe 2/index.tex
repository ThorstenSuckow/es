...
} steht der C-Datentyp \code{phys_addr_t}\footnote{\textit{ebd.}}, der - je nach Rechnerarchitektur - einem \texttt{unsigned integer} der Wortgröße 32-Bit oder 64-Bit entspricht.
